document.getElementById("home").addEventListener("mouseover",function(){
    document.getElementById("message").innerHTML="<p>Coding-Themed Games:</p><p>Hover to see the description of the game and click to play.</p>";
})
document.getElementById("DD").addEventListener("mouseover",function(){
    document.getElementById("message").innerHTML="<p>Method Scramble:</p><p>Drag and drop the pieces into the right spots to build an add event listener. Click the show answer button to see the answer at the top of the page.</p>";
})
document.getElementById("Crossword").addEventListener("mouseover",function(){
